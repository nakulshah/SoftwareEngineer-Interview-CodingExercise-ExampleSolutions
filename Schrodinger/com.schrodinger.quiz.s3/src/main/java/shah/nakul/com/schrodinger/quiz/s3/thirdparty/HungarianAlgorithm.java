...
package shah.nakul.com.schrodinger.quiz.s3.thirdparty;

/**
 * https://raw.github.com/mudspike/sokoban-searcher/master/src/HungarianAlgorithm.java
 * @author https://github.com/mudspike
 * @author lucky7user - I modified the code to make it accept double values
 * FYI: This is a third party code
 * 
 */
...
public class HungarianAlgorithm {
	...
	private static double[][] copyOf	(double[][] costs)		//Copies all elements of an array to a new array.
		
	{
		double[][] copy = new double[costs.length][costs[0].length];
	...
	public static double[][] hgAlgorithm (double[][] costs, String sumType)
	{
		double[][] cost = copyOf(costs);	//Create the cost matrix
		...
		double[][] mask = new double[cost.length][cost[0].length];	//The mask array.
		double[] rowCover = new double[cost.length];					//The row covering vector.
		double[] colCover = new double[cost[0].length];				//The column covering vector.
		...
		double[][] assignment = new double[costs.length][3];	//Create the returned array.
...
//		return sum;
	...
	private static int hg_step2(int step, double[][] cost, double[][] mask, double[]rowCover, double[] colCover)
	{
		//What STEP 2 does:
	...
	private static int hg_step3(int step, double[][] mask, double[] colCover)
	{
		//What STEP 3 does:
	...
	private static int hg_step4(int step, double[][] cost, double[][] mask, double[] rowCover, double[] colCover, int[] zero_RC)
	{
		//What STEP 4 does:
	...
	(int[] row_col, double[][] cost, double[] rowCover, double[] colCover)
	{
	...
	private static int hg_step5(int step, double[][] mask, double[] rowCover, double[] colCover, int[] zero_RC)
	{
		//What STEP 5 does:	
	...
	(double[][] mask, int[][] path, double count)
	{
	...
	(double[] rowCover, double[] colCover)
	{
	...
	private static int hg_step6(int step, double[][] cost, double[] rowCover, double[] colCover, double maxCost)
	{
		//What STEP 6 does:
	...
	(double[][] cost, double[] rowCover, double[] colCover, double maxCost)
	{
